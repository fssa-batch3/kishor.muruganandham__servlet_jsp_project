            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="user-profile" title="Profile Image">
                        <img src="<%= session.getAttribute("profileImage") %>" alt="Profile Image" class="rounded-circle rounded-image">
                    </a>
                </li>
            </ul>
        </div>
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasNav"
    ...
    <div class="offcanvas-body">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="borrow-list">Borrow List</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="create-book.jsp">Create Book</a>
            </li>
            <li class="nav-item">
