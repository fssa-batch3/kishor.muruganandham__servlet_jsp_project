...
<style>
  ...
  .container-center {
    ...
    align-items: center;
    min-height: 100vh; /* Vertically center content on the page */
  }
  .circular-image {
    border-radius: 50%;
    width: 150px;
			...
			<form id="profileForm" method="post" action="update-user">
				...
				<div class="form-check">
					<input class="form-check-input" type="radio" name="gender"
						...
						${editable ? (user.gender.equals('M') ? "checked" : "") : "disabled"}>
				...
				<div class="form-check">
					...
					<label class="form-check-label" for="femaleGender"> Female
					</label>
				</div>
				...
				<br> <label for="dob">Date of Birth:</label> <input type="date"
					...
					id="profileImage" name="profileImage" hidden=true
				...
				<button type="button" id="deleteButton" ${editable ? "hidden" : ""}
