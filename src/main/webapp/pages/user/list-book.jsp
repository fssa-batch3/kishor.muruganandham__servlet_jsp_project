...
<body>
	<nav class="sidebar" id="sidebar">
		<div class="side-header">
			...
			<div class="nav-list">
				<a href="./homepage.html" class="nav-items"><i
					class="bi bi-house"></i>
					<p>Home</p>
					...
					<div class="tooltip" role="tooltip" style="top: 255px"
						...
						History
						<div class="arrow" data-popper-arrow></div>
					</div> </a> <a href="./favourites.html" class="nav-items"><i
					...
					<div class="tooltip" role="tooltip" style="top: 315px"
						...
						Favourites
						<div class="arrow" data-popper-arrow></div>
					</div> </a> <a href="./book-request.html" class="nav-items"><i
			...
			<div class="library-section generated-books books-section-style">
				<c:forEach items="${bookList}" var="book">
					<div data-id="${book.bookId}" class="book">
						<a class="book-cover"
							href="book-details?bookId=${book.bookId}"
