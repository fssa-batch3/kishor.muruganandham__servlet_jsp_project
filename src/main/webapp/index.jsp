  ...
  <body>
    <div class="container">
      <div class="tab-group">
        ...
        <button class="tab-btn" onclick="activeTab(event, 'sign-up')">
          Sign Up
        </button>
      </div>

      <form id="sign-in" class="tab-content" style="height: fit-content" action="login" method="post">
      <c:if test="${not empty requestScope.errorMessage}">      
		<div class="error-msg"><small style="display: block;font-size: 16px;">${errorMessage}</small></div>
      </c:if>
      <c:if test="${not empty requestScope.successMessage}">      
		<div class="error-msg"><small style="display: block;font-size: 16px; background-color: var(--success-green-shade);
    color: var(--success-green);">${successMessage}</small></div>
      </c:if>
        <div class="title">
          <h1>Welcome Back</h1>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-field">
            <input
              ...
              class="input"
              onblur="validateUsername('username-sign-in','.email-error')"
              required
              value="${loginEmail}"
            />
          </div>
        ...
        <div class="input-group">
          ...
          <div class="input-field">
            ...
            />
            <i
              class="bi bi-eye-fill pass-visible sign-in"
              onclick="togglePasswordVisibility('password-sign-in','.pass-visible.sign-in')"
            ></i>
          </div>
          <div class="error-msg">
            <small class="sign-in-password-error"
        ...
        <a href="./pages/user/forget_password.html" class="forget-password"
          >Forget Password ?</a
        >
        <div class="input-group">
          ...
          <div class="input-group">
            ...
            <div class="input-field">
              <input
                ...
                maxlength="32"
                value="${signupName}"
                title="Name Should contain only 32 characters and cannot contain numbers"
                required
              />
            </div>
          </div>
          ...
          <div class="input-group">
            ...
            <div class="input-field">
              ...
              <i
                ...
                onclick="togglePasswordVisibility('password-sign-up','.pass-visible.pass-sign-up')"
              ></i>
            </div>
            <div class="error-msg">
              <small class="sign-up-password-error"
                >Seems like your password doesn't match.</small
              >
            </div>
          </div>
          <div class="input-group">
            <label for="confirm-password-sign-up"
            ...
            <div class="input-field">
              ...
              <i
                ...
                onclick="togglePasswordVisibility('confirm-password-sign-up','.pass-visible.confirm-sign-up')"
              ></i>
            </div>
            <div class="error-msg">
              <small class="confirm-password-sign-up"
                >Seems like your password doesn't match.</small
              >
            </div>
          </div>
